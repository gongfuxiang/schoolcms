...
class Email
{
	public function __construct()
	{
		...
		$mail->AddAddress("fuxiang.gong@qq.com", "用户接收111");//收件人地址，可以替换成任何想要接收邮件的email信箱,格式是AddAddress("收件人email","收件人姓名")

		$mail->IsHTML(true);//是否开启html格式
		$mail->CharSet = "utf-8";//设置编码

		$mail->Subject = "邮件标题";//邮件标题
		$mail->Body = "<b style='color:#F00;font-size:30px;'>ddddtest</b><img src='http://i.haotukankan.com/img/logo.png' />";//邮件内容
