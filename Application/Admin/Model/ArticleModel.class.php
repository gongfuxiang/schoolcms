...
class ArticleModel extends CommonModel
{
	...
	protected $_validate = array(		
		// 添加,编辑
		array('username', 'CheckUserName', '{%article_username_format}', 1, 'callback', 3),
		array('id_card', 'CheckIdCard', '{%common_view_id_card_format}', 1, 'callback', 3),
		array('gender', array(0,1,2), '{%common_gender_tips}', 1, 'in', 3),
		array('birthday', 'CheckBirthday', '{%article_birthday_format}', 2, 'callback', 3),
		array('state', array(0,1,2,3,4), '{%common_article_state_tips}', 1, 'in', 3),
