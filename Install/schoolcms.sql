...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=516 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局管理';
