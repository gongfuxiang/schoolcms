...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', '4086e717ab92c1fff5881571bce2e12a', '175376', '', '0', '238', '1490351171', '1', '1481350313', '2017-03-24 18:26:11'), ('3', 'testtest', '1808a1bde8b9687115b9bf75e4341e77', '556327', '', '0', '24', '1488124597', '13', '1483947758', '2017-02-26 23:56:37');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='基本配置参数';

-- ----------------------------
--  Records of `sc_config`
-- ----------------------------
BEGIN;
INSERT INTO `sc_config` VALUES ('15', '10', '分页数量', '分页显示数量', '分页不能超过3位数', 'admin', 'admin_page_number', '1490240495'), ('3', '20', '成绩等级', '差', '差,较差,中,良,优，不能超过3位数', 'admin', 'admin_fraction_weak', '1490240495'), ('4', '40', '成绩等级', '较差', '', 'admin', 'admin_fraction_poor', '1490240495'), ('5', '60', '成绩等级', '中', '', 'admin', 'admin_fraction_commonly', '1490240495'), ('6', '80', '成绩等级', '良', '', 'admin', 'admin_fraction_good', '1490240495'), ('7', '100', '成绩等级', '优', '', 'admin', 'admin_fraction_excellent', '1490240495'), ('8', '7', '学期', '当前学期类id', '请选择学期', 'admin', 'admin_semester_id', '1490240495'), ('11', '1', 'Excel编码', 'excel模块编码选择', '请选择编码', 'admin', 'admin_excel_charset', '1490240495'), ('16', 'SchoolCMS学校管理系统 - Powered by SchoolCMS', '站点标题', '浏览器标题，一般不超过80个字符', '站点标题不能为空', 'home', 'home_seo_site_title', '1488852831'), ('17', 'SchoolCMS,学校管理系统,教务管理系统', '站点关键字', '一般不超过100个字符，多个关键字以半圆角逗号 [ , ] 隔开', '站点关键字不能为空', 'home', 'home_seo_site_keywords', '1488852831'), ('18', 'SchoolCMS国内首个开源教务管理系统', '站点描述', '站点描述，一般不超过200个字符', '站点描述不能为空', 'home', 'home_seo_site_description', '1488852831'), ('19', '', 'ICP证书号', 'ICP域名备案号', '', 'home', 'home_site_icp', '1490169250'), ('20', '', '底部统计代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_statistics_code', '0'), ('21', '1', '站点状态', '可暂时将站点关闭，其他人无法访问，但不影响管理员访问后台', '请选择站点状态', 'home', 'home_site_state', '1490169250'), ('22', '升级中...', '关闭原因', '支持html，当网站处于关闭状态时，关闭原因将显示在前台', '', 'home', 'home_site_close_reason', '1490169250'), ('23', 'Europe/Andorra', '默认时区', '默认 亚洲/上海 [标准时+8]', '请选择默认时区', 'common', 'common_timezone', '1490169250'), ('24', '', '底部代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_footer_info', '1490169250'), ('28', 'SchoolCMS', '站点名称', '', '站点名称不能为空', 'home', 'home_site_name', '1490169249'), ('29', '0', '链接模式', '详情ThinkPHP官网3.2版本文档 [http://www.thinkphp.cn/]', '请选择url模式', 'home', 'home_seo_url_model', '1488852831'), ('25', '2048000', '图片最大限制', '单位B [上传图片还受到服务器空间PHP配置最大上传 20M 限制]', '请填写图片上传最大限制', 'home', 'home_max_limit_image', '1490169250'), ('26', '51200000', '文件最大限制', '单位B [上传文件还受到服务器空间PHP配置最大上传 20M 限制]', '请填写文件上传最大限制', 'home', 'home_max_limit_file', '1490169250'), ('27', '102400000', '视频最大限制', '单位B [上传视频还受到服务器空间PHP配置最大上传 20M 限制]', '请填写视频上传最大限制', 'home', 'home_max_limit_video', '1490169250'), ('30', 'html', '伪静态后缀', '链接后面的后缀别名', '小写字母，不能超过8个字符', 'home', 'home_seo_url_html_suffix', '1488852831'), ('31', '1', '文章标题方案', '文章浏览器标题方案', '请选择文章标题方案', 'home', 'home_seo_article_browser', '1488852831'), ('32', '1', '频道标题方案', '频道浏览器标题方案', '请选择频道标题方案', 'home', 'home_seo_channel_browser', '1488852831'), ('33', '/Public/Upload/Home/image/1489141745_logo.png', '站点logo', '尺寸最大180x38像数，支持 [jpg, png, gif]', '请上传网站logo', 'home', 'home_site_logo', '1490169249'), ('34', '1000', '页面最大宽度', '页面最大宽度，单位px，0则100%', '请填写页面最大宽度值', 'home', 'home_content_max_width', '1490169250'), ('35', '56.23', '图片比例', '为了站点自适应结构美观，图片尺寸需要统一比例[计算规则 比例值除以100再乘以图片宽度] 得到高度', '图片比例值格式有误，必须大于0，小数点后面最大两位', 'common', 'common_image_proportion', '1490240495'), ('36', 'sms,email', '是否开启注册', '关闭注册后，前台站点将无法注册，可选择 [ 短信, 邮箱 ]', '请选择是否开启注册状态', 'home', 'home_user_reg_state', '1490169250'), ('37', '1', '是否开启登录', '关闭后，前台站点将无法登录', '请选择是否开启登录状态', 'home', 'home_user_login_state', '1490169250'), ('38', '1', '获取验证码-开启图片验证码', '防止短信轰炸', '请选择是否开启强制图片验证码', 'home', 'home_img_verify_state', '1490169250'), ('39', '30', '获取验证码时间间隔', '防止频繁获取验证码，一般在 30~120 秒之间，单位 [秒]', '请填写获取验证码时间间隔', 'home', 'common_verify_time_interval', '1490169250'), ('40', '用户注册，验证码：#code#，10分钟内有效。如非本人操作请忽略本短信', '用户注册-短信模板', '验证码变量标识符 [ #code# ]，详情云片官网 [https://www.yunpian.com/]', '请填写用户注册短信模板内容', 'home', 'home_sms_user_reg', '1490351181'), ('41', '美啦网', '短信签名', '发送短信包含的签名', '短信签名 3~8 个的中英文字符', 'home', 'common_sms_sign', '1490168548'), ('42', '17171d4ff3510ae8f532a70401e41067', '短信密钥', 'APIKEY接口请求密钥', '请填写APIKEY密钥', 'home', 'common_sms_apikey', '1490168548'), ('43', '密码找回，验证码：#code#，10分钟内有效。打死也不要告诉别人哦！', '密码找回-短信模板', '验证码变量标识符 [ #code# ]，详情云片官网 [https://www.yunpian.com/]', '请填写密码找回短信模板内容', 'home', 'home_sms_user_forget_pwd', '1490351181'), ('44', '600', '验证码有效时间', '验证码过期时间，一般10分钟左右，单位 [秒]', '请填写验证码有效时间', 'home', 'common_verify_expire_time', '1490169250'), ('45', 'smtp.163.com', 'SMTP服务器', '设置SMTP服务器的地址，如 smtp.163.com', '请填写SMTP服务器', 'common', 'common_email_smtp_host', '1489131056'), ('46', '25', 'SMTP端口', '设置SMTP服务器的端口，默认为 25', '请填写SMTP端口号', 'common', 'common_email_smtp_port', '1489131056'), ('47', 'weiletao88@163.com', '发信人邮件地址', '发信人邮件地址，使用SMTP协议发送的邮件地址，如 schoolcms@163.com', '请填写发信人邮件地址', 'common', 'common_email_smtp_account', '1489131056'), ('48', 'weiletao88@163.com', 'SMTP身份验证用户名', '如 schoolcms', '请填写SMTP身份验证用户名', 'common', 'common_email_smtp_name', '1489131056'), ('49', 'weiletao?', 'SMTP身份验证密码', 'schoolcms@163.com邮件的密码，如 123456', '请填写SMTP身份验证密码', 'common', 'common_email_smtp_pwd', '1489131056'), ('50', 'SchoolCMS', '发件人显示名称', '如 schoolcom', '', 'common', 'common_email_smtp_send_name', '1489131056'), ('51', '<p>用户注册，你的验证码是&nbsp;&nbsp;#code#</p><p><br/></p>', '用户注册-邮件模板', '验证码变量标识符 [ #code# ]', '', 'home', 'home_email_user_reg', '1490349707'), ('52', '<p>密码找回，你的验证码是&nbsp;&nbsp;#code#</p>', '密码找回-邮件模板', '验证码变量标识符 [ #code# ]', '', 'home', 'home_email_user_forget_pwd', '1490349707'), ('53', '<p>学生绑定，你的验证码是&nbsp;&nbsp;#code#</p>', '学生绑定-邮件模板', '验证码变量标识符 [ #code# ]', '', 'home', 'home_email_user_student_binding', '1490349707'), ('54', '密码找回，验证码：#code#，10分钟内有效。打死也不要告诉别人哦！', '学生绑定-短信模板', '验证码变量标识符 [ #code# ]，详情云片官网 [https://www.yunpian.com/]', '请填写用户注册短信模板内容', 'home', 'home_sms_user_student_binding', '1490351181');
COMMIT;
...
CREATE TABLE `sc_fraction` (
  ...
  KEY `score` (`score`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='学生成绩';
...
CREATE TABLE `sc_student` (
  ...
  `upd_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_card_semester_id` (`id_card`,`semester_id`) USING BTREE,
  KEY `class_id` (`class_id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_user` VALUES ('12', '', 'fuxiang.gong@qq.com', 'b64275a77a5c4669ecbb6e54b5302f0b', '960658', '', '0', '1489117020', '1489141131'), ('13', '17602128368', '386392432@qq.com', '2ee11ed32b1d59e4f59b244f60713898', '828771', '', '0', '1489141439', '1490351026'), ('14', '13248090273', '', '79c32fce9af43296aeda656654ba129b', '341291', '', '0', '1489145075', '1489159193');
COMMIT;
...
CREATE TABLE `sc_user_student` (
  ...
  KEY `user_id` (`user_id`),
  KEY `student_id` (`student_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='用户关联学生';

-- ----------------------------
--  Records of `sc_user_student`
-- ----------------------------
BEGIN;
INSERT INTO `sc_user_student` VALUES ('1', '13', '8', '1490176253'), ('2', '13', '14', '1490177248'), ('4', '13', '9', '1490239994'), ('5', '13', '13', '1490240196'), ('6', '13', '11', '1490350607'), ('7', '13', '10', '1490351197');
COMMIT;
