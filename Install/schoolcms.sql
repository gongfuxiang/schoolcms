...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=519 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局管理';
...
CREATE TABLE `sc_layout_module` (
  ...
  `upd_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=863 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局模块';
