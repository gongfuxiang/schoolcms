...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', 'fdd0d2c3949b92291a75d3e9be47361b', '378245', '', '0', '253', '1494312609', '1', '1481350313', '2017-05-09 14:50:09'), ('3', 'testtest', '7b2cf5343898484ee47727dfaedc1e02', '991606', '', '0', '26', '1491992579', '13', '1483947758', '2017-04-12 18:22:59');
COMMIT;
...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=513 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局管理';
