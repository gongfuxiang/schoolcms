...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', '91064fcd9c45def0067831e33ce9a09a', '841684', '', '0', '216', '1488160117', '1', '1481350313', '2017-02-27 09:48:37'), ('3', 'testtest', '1808a1bde8b9687115b9bf75e4341e77', '556327', '', '0', '24', '1488124597', '13', '1483947758', '2017-02-26 23:56:37');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='基本配置参数';

-- ----------------------------
--  Records of `sc_config`
-- ----------------------------
BEGIN;
INSERT INTO `sc_config` VALUES ('15', '10', '分页数量', '分页显示数量', '分页不能超过3位数', 'admin', 'admin_page_number', '1488178921'), ('3', '20', '成绩等级', '差', '差,较差,中,良,优，不能超过3位数', 'admin', 'admin_fraction_weak', '1488178921'), ('4', '40', '成绩等级', '较差', '', 'admin', 'admin_fraction_poor', '1488178921'), ('5', '60', '成绩等级', '中', '', 'admin', 'admin_fraction_commonly', '1488178921'), ('6', '80', '成绩等级', '良', '', 'admin', 'admin_fraction_good', '1488178921'), ('7', '100', '成绩等级', '优', '', 'admin', 'admin_fraction_excellent', '1488178921'), ('8', '7', '学期', '当前学期类id', '请选择学期', 'admin', 'admin_semester_id', '1488178921'), ('11', '1', 'Excel编码', 'excel模块编码选择', '请选择编码', 'admin', 'admin_excel_charset', '1488178921'), ('16', 'SchoolCMS', '站点标题', '浏览器标题，一般不超过80个字符', '站点标题不能为空', 'home', 'home_seo_site_title', '1488114206'), ('17', 'SchoolCMS,学校管理系统,教务管理系统', '站点关键字', '一般不超过100个字符，多个关键字以半圆角逗号 [ , ] 隔开', '站点关键字不能为空', 'home', 'home_seo_site_keywords', '1488114206'), ('18', 'SchoolCMS国内首个开源教务管理系统', '站点描述', '站点描述，一般不超过200个字符', '站点描述不能为空', 'home', 'home_seo_site_description', '1488114206'), ('19', '', 'ICP证书号', 'ICP域名备案号', '', 'home', 'home_site_icp', '1488181367'), ('20', '', '底部统计代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_statistics_code', '0'), ('21', '1', '站点状态', '可暂时将站点关闭，其他人无法访问，但不影响管理员访问后台', '请选择站点状态', 'home', 'home_site_state', '1488181367'), ('22', '升级中...', '关闭原因', '支持html，当网站处于关闭状态时，关闭原因将显示在前台', '', 'home', 'home_site_close_reason', '1488181367'), ('23', 'Asia/Shanghai', '默认时区', '默认 亚洲/上海 [标准时+8]', '请选择默认时区', 'common', 'common_timezone', '1488181367'), ('24', '', '底部代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_footer_info', '1488181367'), ('28', 'SchoolCMS', '站点名称', '', '站点名称不能为空', 'home', 'home_site_name', '1488181367'), ('29', '2', '链接模式', '详情ThinkPHP官网3.2版本文档 [http://www.thinkphp.cn/]', '请选择url模式', 'home', 'home_seo_url_model', '1488114206'), ('25', '2048000', '图片最大限制', '单位B [上传图片还受到服务器空间PHP配置最大上传 20M 限制]', '请填写图片上传最大限制', 'home', 'home_max_limit_image', '1488181367'), ('26', '51200000', '文件最大限制', '单位B [上传文件还受到服务器空间PHP配置最大上传 20M 限制]', '请填写文件上传最大限制', 'home', 'home_max_limit_file', '1488181367'), ('27', '102400000', '视频最大限制', '单位B [上传视频还受到服务器空间PHP配置最大上传 20M 限制]', '请填写视频上传最大限制', 'home', 'home_max_limit_video', '1488181367'), ('30', 'html', '伪静态后缀', '链接后面的后缀别名', '小写字母，不能超过8个字符', 'home', 'home_seo_url_html_suffix', '1488114206'), ('31', '1', '文章标题方案', '文章浏览器标题方案', '请选择文章标题方案', 'home', 'home_seo_article_browser', '1488114206'), ('32', '1', '频道标题方案', '频道浏览器标题方案', '请选择频道标题方案', 'home', 'home_seo_channel_browser', '1488114206'), ('33', '/Public/Upload/Home/image/1488181367_logo.png', '站点logo', '尺寸最大180x38像数，支持 [jpg, png, gif]', '请上传网站logo', 'home', 'home_site_logo', '1488181367'), ('34', '1200', '页面最大宽度', '页面最大宽度，单位px，0则100%', '请填写页面最大宽度值', 'home', 'home_content_max_width', '1488181367'), ('35', '56.23', '图片比例', '为了站点自适应结构美观，图片尺寸需要统一比例[计算规则 比例值除以100再乘以图片宽度] 得到高度', '图片比例值格式有误，必须大于0，小数点后面最大两位', 'common', 'common_image_proportion', '1488178921');
COMMIT;
...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=510 DEFAULT CHARSET=utf8 COMMENT='布局管理';
...
CREATE TABLE `sc_layout_module` (
  ...
  `upd_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=852 DEFAULT CHARSET=utf8 COMMENT='布局模块';
...
CREATE TABLE `sc_link` (
  ...
  KEY `sort` (`sort`),
  KEY `is_enable` (`is_enable`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='友情链接';
...
CREATE TABLE `sc_navigation` (
  ...
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='导航';
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='教师科目关联';

-- ----------------------------
--  Records of `sc_teacher_subject`
-- ----------------------------
BEGIN;
INSERT INTO `sc_teacher_subject` VALUES ('14', '4', '17', '1484212426'), ('15', '4', '20', '1484212426'), ('16', '3', '19', '1484212442'), ('17', '3', '20', '1484212442'), ('21', '2', '20', '1484367657'), ('29', '1', '19', '1488122387'), ('30', '1', '20', '1488122387');
COMMIT;
