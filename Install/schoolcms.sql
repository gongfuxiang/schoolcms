...
-- ----------------------------
BEGIN;
INSERT INTO `sc_user` VALUES ('12', '17602128368', 'gfx@gongfuxiang.com', '96c9a8dd067b051f97d230f62b635926', '490717', 'gongfuxiang', '2', '702684000', '', '', '0', '1489117020', '1490871803'), ('13', '17091959688', 'fuxiang.gong@qq.com', '785e7c178a1e8c0592dfc980b642c274', '445006', '', '2', '666226800', '我亲爱的朋友们、感谢你们送来的祝福、祝愿大家开心快乐！', '喜欢睡觉觉', '2', '1489141439', '1490882159'), ('15', '13162155626', '', 'c66b902f95346f4196991efadcab2199', '360741', '', '0', '0', '', '', '1', '1490867166', '1490881752');
COMMIT;
...
CREATE TABLE `sc_user_student` (
  ...
  KEY `user_id` (`user_id`),
  KEY `student_id` (`student_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='用户关联学生';
