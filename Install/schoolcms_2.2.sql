...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', 'db63f6c02afcb1861073bb0c2b636137', '502212', '', '0', '210', '1487753369', '1', '1481350313', '2017-02-22 16:49:29'), ('3', 'testtest', 'd4dc946b6bf6b485efa14ac4ab44ebf5', '364506', '', '0', '20', '1484402389', '13', '1483947758', '2017-01-14 21:59:49');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='基本配置参数';

-- ----------------------------
--  Records of `sc_config`
-- ----------------------------
BEGIN;
INSERT INTO `sc_config` VALUES ('15', '10', '分页数量', '分页显示数量', '分页不能超过3位数', 'admin', 'admin_page_number', '1487945072'), ('3', '20', '成绩等级', '差', '差,较差,中,良,优，不能超过3位数', 'admin', 'admin_fraction_weak', '1487945072'), ('4', '40', '成绩等级', '较差', '', 'admin', 'admin_fraction_poor', '1487945072'), ('5', '60', '成绩等级', '中', '', 'admin', 'admin_fraction_commonly', '1487945072'), ('6', '80', '成绩等级', '良', '', 'admin', 'admin_fraction_good', '1487945072'), ('7', '100', '成绩等级', '优', '', 'admin', 'admin_fraction_excellent', '1487945072'), ('8', '7', '学期', '当前学期类id', '请选择学期', 'admin', 'admin_semester_id', '1487945072'), ('11', '1', 'Excel编码', 'excel模块编码选择', '请选择编码', 'admin', 'admin_excel_charset', '1487945072'), ('16', 'SchoolCMS', '站点标题', '', '站点标题不能为空', 'home', 'home_site_title', '1487945678'), ('17', 'SchoolCMS,学校管理系统,教务管理系统', '站点关键字', 'keywords', '站点关键字不能为空', 'home', 'home_site_keywords', '0'), ('18', 'SchoolCMS国内首个开源教务管理系统', '站点描述', 'description', '站点描述不能为空', 'home', 'home_site_description', '0'), ('19', '', 'ICP证书号', 'ICP域名备案号', '', 'home', 'home_site_icp', '1487945678'), ('20', '', '底部统计代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_statistics_code', '0'), ('21', '1', '站点状态', '可暂时将站点关闭，其他人无法访问，但不影响管理员访问后台', '请选择站点状态', 'home', 'home_site_state', '1487945678'), ('22', '升级中……', '关闭原因', '当网站处于关闭状态时，关闭原因将显示在前台', '', 'home', 'home_site_close_reason', '1487945678'), ('23', 'Asia/Shanghai', '默认时区', '默认 亚洲/上海 [标准时+8]', '请选择默认时区', 'common', 'common_timezone', '1487945678'), ('24', '', '底部代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_footer_info', '1487945678'), ('25', '2048000', '图片最大限制', '单位B [上传图片还受到服务器空间PHP配置最大上传 20M 限制]', '请填写图片上传最大限制', 'home', 'home_max_limit_image', '1487945678'), ('26', '51200000', '文件最大限制', '单位B [上传文件还受到服务器空间PHP配置最大上传 20M 限制]', '请填写文件上传最大限制', 'home', 'home_max_limit_file', '1487945678'), ('27', '102400000', '视频最大限制', '单位B [上传视频还受到服务器空间PHP配置最大上传 20M 限制]', '请填写视频上传最大限制', 'home', 'home_max_limit_video', '1487945678');
COMMIT;
