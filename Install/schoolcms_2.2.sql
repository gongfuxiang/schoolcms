...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=471 DEFAULT CHARSET=utf8 COMMENT='布局管理';

-- ----------------------------
--  Records of `sc_layout`
-- ----------------------------
BEGIN;
INSERT INTO `sc_layout` VALUES ('467', 'home', '100', '0', '1487657760', '0'), ('468', 'home', '122', '1', '1487657767', '1'), ('469', 'home', '31', '2', '1487657782', '0'), ('470', 'home', '124', '2', '1487664695', '1');
COMMIT;
...
CREATE TABLE `sc_layout_module` (
  ...
  `upd_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=784 DEFAULT CHARSET=utf8 COMMENT='布局模块';

-- ----------------------------
--  Records of `sc_layout_module`
-- ----------------------------
BEGIN;
INSERT INTO `sc_layout_module` VALUES ('772', '467', '', '', '', '', '10', '80', '', '0', '0', '0', '0', '0', '0', '60', '', '1487657760', '1487658876'), ('773', '468', '教师管', '更多;http://gong.gg', '', '', '10', '80', 'a:3:{i:0;s:1:\"7\";i:1;s:2:\"10\";i:2;s:2:\"16\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487657769', '1487663533'), ('774', '468', '', '', '', '', '10', '80', 'a:1:{i:0;s:1:\"0\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487657769', '1487660237'), ('775', '469', '', '', '', '', '10', '80', '', '0', '0', '0', '0', '0', '0', '60', '', '1487657782', '1487657802'), ('776', '469', '', '', '', '', '10', '80', '', '0', '0', '0', '0', '0', '0', '60', '', '1487657782', '1487657789'), ('778', '468', '', '', '', '', '10', '80', 'a:1:{i:0;s:2:\"10\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487663652', '1487663711'), ('779', '470', '', '', '', '', '10', '80', 'a:1:{i:0;s:1:\"0\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487664696', '1487664702'), ('780', '470', '', '', '', '', '10', '80', 'a:3:{i:0;s:1:\"7\";i:1;s:2:\"10\";i:2;s:2:\"16\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487664697', '1487664745'), ('781', '470', '', '', '', '', '10', '80', 'a:1:{i:0;s:1:\"0\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487664697', '1487664707'), ('782', '470', '', '', '', '', '10', '80', 'a:1:{i:0;s:2:\"16\";}', '0', '0', '0', '0', '0', '0', '60', '', '1487664699', '1487664711');
COMMIT;
