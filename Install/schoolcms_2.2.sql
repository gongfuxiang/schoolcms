...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', '813a3345806c939fecee37ac76916694', '942279', '', '0', '197', '1486378486', '1', '1481350313', '2017-02-06 18:54:46'), ('3', 'testtest', 'd4dc946b6bf6b485efa14ac4ab44ebf5', '364506', '', '0', '20', '1484402389', '13', '1483947758', '2017-01-14 21:59:49');
COMMIT;
...
CREATE TABLE `sc_custom_view` (
  ...
  KEY `access_count` (`access_count`),
  KEY `image_count` (`image_count`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='自定义页面';
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_link` VALUES ('1', 'SchoolCMS', 'http://schoolcms.org/', 'SchoolCMS学校教务管理系统', '0', '1', '1486292373', '2017-02-06 23:17:44'), ('12', 'AmazeUI', 'http://amazeui.org/', 'AmazeUI国内首个HTML5框架', '2', '1', '1486353476', '2017-02-06 23:15:52'), ('13', '龚哥哥的博客', 'http://gong.gg/', '龚哥哥的博客', '1', '1', '1486353528', '2017-02-06 23:18:35');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_navigation` VALUES ('1', '0', '一级导航', 'http://schoolcms.org/', '0', 'custom', 'header', '0', '1', '0', '1486292373', '2017-02-06 11:16:35'), ('2', '0', '哈哈', '', '10', 'article_class', 'header', '0', '1', '0', '1486297310', '2017-02-06 15:58:01'), ('3', '0', '学校风光', '', '16', 'article_class', 'header', '0', '1', '0', '1486298744', '2017-02-05 22:52:25'), ('6', '1', '关于学生', '', '18', 'article_class', 'header', '0', '1', '1', '1486302580', '2017-02-06 11:09:28'), ('7', '1', '客户服务', '', '10', 'article_class', 'header', '0', '1', '0', '1486351011', '2017-02-06 11:16:51'), ('8', '0', '贾玲爆10年旧照 胖瘦之间你最看', '', '1', 'customview', 'header', '0', '1', '0', '1486352254', '2017-02-06 11:39:11'), ('9', '0', '大家新年快乐', '', '6', 'customview', 'header', '0', '1', '0', '1486352437', '2017-02-06 11:45:29'), ('10', '9', '优酷视频观', '', '5', 'customview', 'header', '0', '1', '0', '1486352476', '2017-02-06 11:45:05'), ('12', '0', '底部导航测试', 'http://schoolcms.org/', '0', 'custom', 'footer', '2', '1', '0', '1486353476', '2017-02-06 12:00:32'), ('13', '0', '客户服务', '', '10', 'article_class', 'footer', '1', '1', '0', '1486353528', '2017-02-06 11:59:05');
COMMIT;
