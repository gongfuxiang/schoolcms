...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', 'c71895334e7beb03d6f1e19df224712c', '900862', '', '0', '223', '1489054327', '1', '1481350313', '2017-03-09 18:12:07'), ('3', 'testtest', '1808a1bde8b9687115b9bf75e4341e77', '556327', '', '0', '24', '1488124597', '13', '1483947758', '2017-02-26 23:56:37');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='基本配置参数';

-- ----------------------------
--  Records of `sc_config`
-- ----------------------------
BEGIN;
INSERT INTO `sc_config` VALUES ('15', '10', '分页数量', '分页显示数量', '分页不能超过3位数', 'admin', 'admin_page_number', '1488420466'), ('3', '20', '成绩等级', '差', '差,较差,中,良,优，不能超过3位数', 'admin', 'admin_fraction_weak', '1488420466'), ('4', '40', '成绩等级', '较差', '', 'admin', 'admin_fraction_poor', '1488420466'), ('5', '60', '成绩等级', '中', '', 'admin', 'admin_fraction_commonly', '1488420466'), ('6', '80', '成绩等级', '良', '', 'admin', 'admin_fraction_good', '1488420466'), ('7', '100', '成绩等级', '优', '', 'admin', 'admin_fraction_excellent', '1488420466'), ('8', '7', '学期', '当前学期类id', '请选择学期', 'admin', 'admin_semester_id', '1488420466'), ('11', '1', 'Excel编码', 'excel模块编码选择', '请选择编码', 'admin', 'admin_excel_charset', '1488420466'), ('16', 'SchoolCMS学校管理系统 - Powered by SchoolCMS', '站点标题', '浏览器标题，一般不超过80个字符', '站点标题不能为空', 'home', 'home_seo_site_title', '1488852831'), ('17', 'SchoolCMS,学校管理系统,教务管理系统', '站点关键字', '一般不超过100个字符，多个关键字以半圆角逗号 [ , ] 隔开', '站点关键字不能为空', 'home', 'home_seo_site_keywords', '1488852831'), ('18', 'SchoolCMS国内首个开源教务管理系统', '站点描述', '站点描述，一般不超过200个字符', '站点描述不能为空', 'home', 'home_seo_site_description', '1488852831'), ('19', '', 'ICP证书号', 'ICP域名备案号', '', 'home', 'home_site_icp', '1489071088'), ('20', '', '底部统计代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_statistics_code', '0'), ('21', '1', '站点状态', '可暂时将站点关闭，其他人无法访问，但不影响管理员访问后台', '请选择站点状态', 'home', 'home_site_state', '1489071088'), ('22', '升级中...', '关闭原因', '支持html，当网站处于关闭状态时，关闭原因将显示在前台', '', 'home', 'home_site_close_reason', '1489071088'), ('23', 'Asia/Shanghai', '默认时区', '默认 亚洲/上海 [标准时+8]', '请选择默认时区', 'common', 'common_timezone', '1489071088'), ('24', '', '底部代码', '支持html，可用于添加流量统计代码', '', 'home', 'home_footer_info', '1489071088'), ('28', 'SchoolCMS', '站点名称', '', '站点名称不能为空', 'home', 'home_site_name', '1489071088'), ('29', '0', '链接模式', '详情ThinkPHP官网3.2版本文档 [http://www.thinkphp.cn/]', '请选择url模式', 'home', 'home_seo_url_model', '1488852831'), ('25', '2048000', '图片最大限制', '单位B [上传图片还受到服务器空间PHP配置最大上传 20M 限制]', '请填写图片上传最大限制', 'home', 'home_max_limit_image', '1489071088'), ('26', '51200000', '文件最大限制', '单位B [上传文件还受到服务器空间PHP配置最大上传 20M 限制]', '请填写文件上传最大限制', 'home', 'home_max_limit_file', '1489071088'), ('27', '102400000', '视频最大限制', '单位B [上传视频还受到服务器空间PHP配置最大上传 20M 限制]', '请填写视频上传最大限制', 'home', 'home_max_limit_video', '1489071088'), ('30', 'html', '伪静态后缀', '链接后面的后缀别名', '小写字母，不能超过8个字符', 'home', 'home_seo_url_html_suffix', '1488852831'), ('31', '1', '文章标题方案', '文章浏览器标题方案', '请选择文章标题方案', 'home', 'home_seo_article_browser', '1488852831'), ('32', '1', '频道标题方案', '频道浏览器标题方案', '请选择频道标题方案', 'home', 'home_seo_channel_browser', '1488852831'), ('33', '/Public/Upload/Home/image/1488181367_logo.png', '站点logo', '尺寸最大180x38像数，支持 [jpg, png, gif]', '请上传网站logo', 'home', 'home_site_logo', '1489071088'), ('34', '1200', '页面最大宽度', '页面最大宽度，单位px，0则100%', '请填写页面最大宽度值', 'home', 'home_content_max_width', '1489071088'), ('35', '56.23', '图片比例', '为了站点自适应结构美观，图片尺寸需要统一比例[计算规则 比例值除以100再乘以图片宽度] 得到高度', '图片比例值格式有误，必须大于0，小数点后面最大两位', 'common', 'common_image_proportion', '1488420466'), ('36', '1', '是否开启注册', '关闭注册后，前台站点将无法注册', '请选择是否开启注册状态', 'home', 'home_user_reg_state', '1489071088'), ('37', '1', '是否开启登录', '关闭后，前台站点将无法登录', '请选择是否开启登录状态', 'home', 'home_user_login_state', '1489071088'), ('38', '1', '用户注册-开启图片验证码', '防止短信轰炸', '请选择是否开启强制图片验证码', 'home', 'home_user_reg_img_verify_state', '1489071097'), ('39', '30', '获取验证码时间间隔', '防止频繁获取验证码，一般在 30~120 秒之间，单位 [秒]', '请填写获取验证码时间间隔', 'home', 'common_verify_time_interval', '1489071088'), ('40', '用户注册，验证码：#code#，10分钟内有效。如非本人操作请忽略本短信', '用户注册-短信模板', '验证码变量标识符 [ #code# ]，详情云片官网 [https://www.yunpian.com/]', '请填写用户注册短信模板内容', 'home', 'home_sms_user_reg', '1489071102'), ('41', '美啦网', '短信签名', '发送短信包含的签名', '短信签名 3~8 个的中英文字符', 'home', 'common_sms_sign', '1489071097'), ('42', '17171d4ff3510ae8f532a70401e41067', '短信密钥', 'APIKEY接口请求密钥', '请填写APIKEY密钥', 'home', 'common_sms_apikey', '1489071097'), ('43', '密码找回，验证码：#code#，10分钟内有效。打死也不要告诉别人哦！', '密码找回-短信模板', '验证码变量标识符 [ #code# ]，详情云片官网 [https://www.yunpian.com/]', '请填写密码找回短信模板内容', 'home', 'home_sms_user_forget_pwd', '1489071102'), ('44', '600', '验证码有效时间', '验证码过期时间，一般10分钟左右，单位 [秒]', '请填写验证码有效时间', 'home', 'common_verify_expire_time', '1489071088'), ('45', 'smtp.163.com', 'SMTP服务器', '设置SMTP服务器的地址，如 smtp.163.com', '请填写SMTP服务器', 'common', 'common_email_smtp_host', '1489071478'), ('46', '25', 'SMTP端口', '设置SMTP服务器的端口，默认为 25', '请填写SMTP端口号', 'common', 'common_email_smtp_port', '1489071478'), ('47', 'weiletao88@163.com', '发信人邮件地址', '发信人邮件地址，使用SMTP协议发送的邮件地址，如 schoolcms@163.com', '请填写发信人邮件地址', 'common', 'common_email_smtp_account', '1489071478'), ('48', 'weiletao88@163.com', 'SMTP身份验证用户名', '如 schoolcms', '请填写SMTP身份验证用户名', 'common', 'common_email_smtp_name', '1489071478'), ('49', 'weiletao?', 'SMTP身份验证密码', 'schoolcms@163.com邮件的密码，如 123456', '请填写SMTP身份验证密码', 'common', 'common_email_smtp_pwd', '1489071478'), ('50', 'SchoolCMS', '发件人显示名称', '如 SchoolCMS', '', 'common', 'common_email_smtp_send_name', '1489071478'), ('51', '<p>用户注册，你的验证码是&nbsp;&nbsp;#code#</p><p><br/></p>', '用户注册-模板', '验证码变量标识符 [ #code# ]', '', 'home', 'home_email_user_reg', '1489071496'), ('52', '<p>密码找回，你的验证码是&nbsp;&nbsp;#code#</p>', '密码找回-模板', '验证码变量标识符 [ #code# ]', '', 'home', 'home_email_user_forget_pwd', '1489071496');
COMMIT;
...
CREATE TABLE `sc_layout` (
  ...
  KEY `value` (`value`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=510 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局管理';

-- ----------------------------
--  Records of `sc_layout`
-- ----------------------------
BEGIN;
INSERT INTO `sc_layout` VALUES ('1', 'home_link', '', '255', '1487657767', '1'), ('2', 'channel_link', '', '255', '1487657767', '1'), ('3', 'detail_link', '', '255', '1487657767', '1'), ('475', 'home', '84', '0', '1487728772', '1'), ('494', 'channel', '100', '0', '1487741535', '1'), ('501', 'detail', '100', '0', '1487747404', '1'), ('504', 'channel', '100', '1', '1487747719', '1'), ('505', 'home', '123', '3', '1487754569', '1'), ('507', 'home', '100', '1', '1487758192', '1'), ('508', 'home', '48', '2', '1487820317', '0'), ('509', 'detail', '100', '1', '1487835771', '1');
COMMIT;
...
CREATE TABLE `sc_layout_module` (
  ...
  `upd_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=853 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='布局模块';

-- ----------------------------
--  Records of `sc_layout_module`
-- ----------------------------
BEGIN;
INSERT INTO `sc_layout_module` VALUES ('788', '475', '', '', '', '', '10', '80', '0', '0', '0', '0', '8', '0', '0', '60', '', '1487728772', '1488123641'), ('789', '475', '热门文章', '更多;http://gong.gg', '', '阿里|中国', '10', '80', '0', '2', '0', '0', '1', '0', '0', '60', '', '1487728772', '1488542725'), ('827', '494', '热门文章', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '1', '0', '1', '60', '', '1487741535', '1488125040'), ('836', '501', '热门文章', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '1', '0', '0', '60', '', '1487747404', '1488125054'), ('840', '504', '美图', '', '', '', '6', '80', '0', '0', '0', '0', '12', '0', '0', '60', '', '1487747719', '1488125048'), ('841', '505', '关于我们', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '2', '0', '0', '60', '', '1487754570', '1488124966'), ('842', '505', '校园动态', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '2', '0', '0', '60', '', '1487754571', '1488125094'), ('843', '505', '领导新闻', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '1', '0', '0', '60', '', '1487754572', '1488124984'), ('844', '505', '优秀学生', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '1', '0', '0', '60', '', '1487754573', '1488124989'), ('845', '505', '生活常识', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '2', '0', '1', '60', '', '1487754582', '1488125005'), ('846', '505', '学习技巧', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '2', '0', '1', '60', '', '1487754583', '1488125016'), ('848', '507', '', '', '', '', '10', '160', '0', '0', '0', '0', '15', '0', '0', '60', '', '1487758192', '1488124907'), ('849', '508', '地地道道', '', '', '', '10', '80', '0', '0', '0', '0', '2', '0', '0', '60', '', '1487820317', '1488125314'), ('850', '508', '地地道道', '', '', '', '3', '80', '0', '0', '0', '0', '6', '0', '0', '60', '', '1487820317', '1488125318'), ('851', '509', '图文', '更多;http://gong.gg', '', '', '10', '80', '0', '0', '0', '0', '6', '0', '0', '60', '', '1487835771', '1488125059');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1145 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='角色与权限管理';

-- ----------------------------
--  Records of `sc_role_power`
-- ----------------------------
BEGIN;
INSERT INTO `sc_role_power` VALUES ('1039', '13', '41', '1488124443'), ('1040', '13', '42', '1488124443'), ('1041', '13', '1', '1488124443'), ('1042', '13', '22', '1488124443'), ('1043', '13', '4', '1488124443'), ('1044', '13', '28', '1488124443'), ('1045', '13', '29', '1488124443'), ('1046', '13', '32', '1488124443'), ('1047', '13', '33', '1488124443'), ('1048', '13', '34', '1488124443'), ('1049', '13', '63', '1488124443'), ('1050', '13', '30', '1488124443'), ('1051', '13', '31', '1488124443'), ('1052', '13', '35', '1488124443'), ('1053', '13', '37', '1488124443'), ('1054', '13', '36', '1488124443'), ('1055', '13', '64', '1488124443'), ('1056', '13', '38', '1488124443'), ('1057', '13', '39', '1488124443'), ('1058', '13', '57', '1488124443'), ('1059', '13', '58', '1488124443'), ('1060', '13', '59', '1488124443'), ('1061', '13', '65', '1488124443'), ('1062', '13', '40', '1488124443'), ('1063', '13', '60', '1488124443'), ('1064', '13', '61', '1488124443'), ('1065', '13', '62', '1488124443'), ('1066', '13', '66', '1488124443'), ('1067', '13', '67', '1488124443'), ('1068', '13', '74', '1488124443'), ('1069', '13', '75', '1488124443'), ('1070', '13', '76', '1488124443'), ('1071', '13', '77', '1488124443'), ('1072', '13', '78', '1488124443'), ('1073', '13', '79', '1488124443'), ('1074', '13', '80', '1488124443'), ('1075', '13', '81', '1488124443'), ('1076', '13', '103', '1488124443'), ('1077', '13', '104', '1488124443'), ('1078', '13', '105', '1488124443'), ('1079', '13', '106', '1488124443'), ('1080', '13', '107', '1488124443'), ('1081', '13', '108', '1488124443'), ('1082', '13', '102', '1488124443'), ('1083', '13', '82', '1488124443'), ('1084', '13', '84', '1488124443'), ('1085', '13', '85', '1488124443'), ('1086', '13', '86', '1488124443'), ('1087', '13', '87', '1488124443'), ('1088', '13', '83', '1488124443'), ('1089', '13', '88', '1488124443'), ('1090', '13', '89', '1488124443'), ('1091', '13', '90', '1488124443'), ('1092', '13', '91', '1488124443'), ('1093', '13', '92', '1488124443'), ('1094', '13', '93', '1488124443'), ('1095', '13', '94', '1488124443'), ('1096', '13', '95', '1488124443'), ('1097', '13', '96', '1488124443'), ('1098', '13', '97', '1488124443'), ('1099', '13', '98', '1488124443'), ('1100', '13', '99', '1488124443'), ('1101', '13', '100', '1488124443'), ('1102', '13', '101', '1488124443'), ('1103', '13', '109', '1488124443'), ('1104', '13', '110', '1488124443'), ('1105', '13', '111', '1488124443'), ('1106', '13', '114', '1488124443'), ('1107', '13', '115', '1488124443'), ('1108', '13', '117', '1488124443'), ('1109', '13', '112', '1488124443'), ('1110', '13', '113', '1488124443'), ('1111', '13', '116', '1488124443'), ('1112', '13', '8', '1488124443'), ('1113', '13', '12', '1488124443'), ('1114', '13', '43', '1488124443'), ('1115', '13', '50', '1488124443'), ('1116', '13', '10', '1488124443'), ('1117', '13', '44', '1488124443'), ('1118', '13', '51', '1488124443'), ('1119', '13', '11', '1488124443'), ('1120', '13', '45', '1488124443'), ('1121', '13', '52', '1488124443'), ('1122', '13', '24', '1488124443'), ('1123', '13', '46', '1488124443'), ('1124', '13', '53', '1488124443'), ('1125', '13', '25', '1488124443'), ('1126', '13', '47', '1488124443'), ('1127', '13', '54', '1488124443'), ('1128', '13', '26', '1488124443'), ('1129', '13', '48', '1488124443'), ('1130', '13', '55', '1488124443'), ('1131', '13', '27', '1488124443'), ('1132', '13', '49', '1488124443'), ('1133', '13', '56', '1488124443'), ('1134', '13', '68', '1488124443'), ('1135', '13', '69', '1488124443'), ('1136', '13', '70', '1488124443'), ('1137', '13', '71', '1488124443'), ('1138', '13', '72', '1488124443'), ('1139', '13', '73', '1488124443'), ('1140', '13', '118', '1488124443'), ('1141', '13', '119', '1488124443'), ('1142', '13', '120', '1488124443'), ('1143', '13', '121', '1488124443'), ('1144', '13', '122', '1488124443');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_semester` VALUES ('7', '2016上学期', '1', '255', '0', '2016-12-25 14:41:23'), ('8', '2016下学期', '1', '0', '0', '2016-12-25 14:41:38'), ('18', 'dsdsa', '1', '0', '1483952728', '2017-01-09 17:05:28');
COMMIT;
...
CREATE TABLE `sc_student` (
  ...
  KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='学生';

-- ----------------------------
--  Records of `sc_student`
-- ----------------------------
BEGIN;
INSERT INTO `sc_student` VALUES ('8', '201700000008', '留洋厄尔', '142613199904234622', '2', '917452800', '7', '22', '7', '尔尔', '03667879265', '', '17602128368', '', '0', '0', '1483932878', '1488426733'), ('9', '201700000009', '张三', '533338198988888888', '2', '736012800', '7', '19', '8', '学校附近的888号', '17000000000', '', '', '', '1', '1', '1483936027', '0'), ('10', '201700000010', '武松打虎', '677771999999999992', '2', '633801600', '7', '20', '9', '', '17666666666', '', '', '', '1', '1', '1483936080', '0'), ('11', '201700000011', '小花', '211118199102111666', '1', '736012800', '7', '19', '11', '住校', '13199999999', '', '', '', '1', '1', '1483936138', '0'), ('12', '201700000012', '大哥哥', '399998198898998887', '2', '839433600', '7', '16', '14', '', '13222222222', '', '', '', '1', '1', '1483936199', '0'), ('13', '201700000013', '地地道道', '441801198810252656', '2', '1483891200', '7', '18', '9', '111', '15915110562', '', '', '', '3', '1', '1483948630', '0'), ('14', '201700000014', '测试学生', '522228199111111111', '2', '666547200', '7', '17', '9', '20号', '', '', '17602128368', '386392432@qq.com', '0', '0', '1488426236', '1488449382');
COMMIT;
...
CREATE TABLE `sc_teacher_subject` (
  ...
  KEY `teacher_id` (`teacher_id`),
  KEY `subject_id` (`subject_id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='教师科目关联';

-- ----------------------------
--  Records of `sc_teacher_subject`
-- ----------------------------
BEGIN;
INSERT INTO `sc_teacher_subject` VALUES ('14', '4', '17', '1484212426'), ('15', '4', '20', '1484212426'), ('16', '3', '19', '1484212442'), ('17', '3', '20', '1484212442'), ('43', '1', '19', '1488449032'), ('44', '1', '20', '1488449032'), ('45', '2', '20', '1488449060');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_user` VALUES ('8', '17602128368', '', 'ad13744c3f241b3fed152ceb8751c91b', '646447', '', '0', '1489046096', '1489046456'), ('9', '13248090273', '', '5bfc4e47100c2ea5de01925307d48d16', '217976', '', '0', '1489046609', '1489046609');
COMMIT;
