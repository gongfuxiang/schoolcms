...
CREATE TABLE `sc_fraction` (
  ...
  KEY `score` (`score`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='学生成绩';
...
CREATE TABLE `sc_power` (
  ...
  `add_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='权限';
...
CREATE TABLE `sc_role_power` (
  ...
  `add_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=325 DEFAULT CHARSET=utf8 COMMENT='角色与权限管理';

-- ----------------------------
--  Records of `sc_role_power`
-- ----------------------------
BEGIN;
INSERT INTO `sc_role_power` VALUES ('56', '3', '8', '1482048726'), ('57', '3', '10', '1482048726'), ('58', '3', '11', '1482048726'), ('59', '4', '1', '1482048733'), ('60', '4', '4', '1482048733'), ('61', '4', '8', '1482048733'), ('62', '4', '12', '1482048733'), ('63', '6', '1', '1482049270'), ('64', '6', '4', '1482049270'), ('65', '6', '8', '1482049270'), ('66', '6', '10', '1482049270'), ('67', '6', '12', '1482049270'), ('72', '9', '1', '1482049321'), ('73', '9', '4', '1482049321'), ('184', '2', '1', '1482598465'), ('185', '2', '22', '1482598465'), ('186', '2', '19', '1482598465'), ('187', '2', '4', '1482598465'), ('188', '2', '13', '1482598465'), ('189', '2', '8', '1482598465'), ('190', '2', '10', '1482598465'), ('191', '2', '11', '1482598465'), ('192', '2', '12', '1482598465'), ('213', '5', '8', '1482679618'), ('214', '5', '10', '1482679618'), ('295', '1', '1', '1483176277'), ('296', '1', '22', '1483176277'), ('297', '1', '19', '1483176277'), ('298', '1', '20', '1483176277'), ('299', '1', '21', '1483176277'), ('300', '1', '4', '1483176277'), ('301', '1', '17', '1483176277'), ('302', '1', '18', '1483176277'), ('303', '1', '23', '1483176277'), ('304', '1', '13', '1483176277'), ('305', '1', '15', '1483176277'), ('306', '1', '16', '1483176277'), ('307', '1', '28', '1483176277'), ('308', '1', '29', '1483176277'), ('309', '1', '32', '1483176277'), ('310', '1', '33', '1483176277'), ('311', '1', '34', '1483176277'), ('312', '1', '30', '1483176277'), ('313', '1', '31', '1483176277'), ('314', '1', '35', '1483176277'), ('315', '1', '37', '1483176277'), ('316', '1', '36', '1483176277'), ('317', '1', '8', '1483176277'), ('318', '1', '12', '1483176277'), ('319', '1', '10', '1483176277'), ('320', '1', '11', '1483176277'), ('321', '1', '24', '1483176277'), ('322', '1', '25', '1483176277'), ('323', '1', '26', '1483176277'), ('324', '1', '27', '1483176277');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_student` VALUES ('3', '龚福祥', '522228199102111214', '0', '1470931200', '0', '16', '7', '', '17602128368', '0', '0', '1483002280', '2016-12-29 17:04:40');
COMMIT;
