...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='基本配置参数';

-- ----------------------------
--  Records of `sc_config`
-- ----------------------------
BEGIN;
INSERT INTO `sc_config` VALUES ('3', '20', '差', '成绩等级 差', 'fraction_weak'), ('4', '40', '较差', '成绩等级 较差', 'fraction_poor'), ('5', '60', '中', '成绩等级 中', 'fraction_commonly'), ('6', '80', '良', '成绩等级 良', 'fraction_good'), ('7', '100', '优', '成绩等级 优', 'fraction_excellent'), ('8', '1', '学期', '当前学期类id', 'semester_id'), ('11', '1', 'csv编码', 'csv模块编码选择', 'csv_charset');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_fraction` VALUES ('5', '0', '5', '12', '12', '80', '1483283057', '2017-01-01 23:04:17');
COMMIT;
...
CREATE TABLE `sc_role_power` (
  ...
  `add_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=392 DEFAULT CHARSET=utf8 COMMENT='角色与权限管理';

-- ----------------------------
--  Records of `sc_role_power`
-- ----------------------------
BEGIN;
INSERT INTO `sc_role_power` VALUES ('56', '3', '8', '1482048726'), ('57', '3', '10', '1482048726'), ('58', '3', '11', '1482048726'), ('59', '4', '1', '1482048733'), ('60', '4', '4', '1482048733'), ('61', '4', '8', '1482048733'), ('62', '4', '12', '1482048733'), ('63', '6', '1', '1482049270'), ('64', '6', '4', '1482049270'), ('65', '6', '8', '1482049270'), ('66', '6', '10', '1482049270'), ('67', '6', '12', '1482049270'), ('72', '9', '1', '1482049321'), ('73', '9', '4', '1482049321'), ('184', '2', '1', '1482598465'), ('185', '2', '22', '1482598465'), ('186', '2', '19', '1482598465'), ('187', '2', '4', '1482598465'), ('188', '2', '13', '1482598465'), ('189', '2', '8', '1482598465'), ('190', '2', '10', '1482598465'), ('191', '2', '11', '1482598465'), ('192', '2', '12', '1482598465'), ('213', '5', '8', '1482679618'), ('214', '5', '10', '1482679618'), ('358', '1', '41', '1483362423'), ('359', '1', '1', '1483362423'), ('360', '1', '22', '1483362423'), ('361', '1', '19', '1483362423'), ('362', '1', '20', '1483362423'), ('363', '1', '21', '1483362423'), ('364', '1', '4', '1483362423'), ('365', '1', '17', '1483362423'), ('366', '1', '18', '1483362423'), ('367', '1', '23', '1483362423'), ('368', '1', '13', '1483362423'), ('369', '1', '15', '1483362423'), ('370', '1', '16', '1483362423'), ('371', '1', '28', '1483362423'), ('372', '1', '29', '1483362423'), ('373', '1', '32', '1483362423'), ('374', '1', '33', '1483362423'), ('375', '1', '34', '1483362423'), ('376', '1', '30', '1483362423'), ('377', '1', '31', '1483362423'), ('378', '1', '35', '1483362423'), ('379', '1', '37', '1483362423'), ('380', '1', '36', '1483362423'), ('381', '1', '38', '1483362423'), ('382', '1', '39', '1483362423'), ('383', '1', '40', '1483362423'), ('384', '1', '8', '1483362423'), ('385', '1', '12', '1483362423'), ('386', '1', '10', '1483362423'), ('387', '1', '11', '1483362423'), ('388', '1', '24', '1483362423'), ('389', '1', '25', '1483362423'), ('390', '1', '26', '1483362423'), ('391', '1', '27', '1483362423');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_student` VALUES ('5', '龚福祥', '522228199102111214', '2', '1504886400', '0', '18', '7', '啊啊', '17602128368', '0', '0', '1483271562', '2017-01-01 23:04:39');
COMMIT;
